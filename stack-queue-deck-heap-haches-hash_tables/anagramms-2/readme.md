...
**Входные данные**  
В первой строке дано число n (1≤n≤1000) — длина первого массива.  
Во второй строке через пробел заданы n чисел a_i (1≤a_i≤100000) — первый массив.  
В третьей строке дано число m (1≤m≤1000) — длина второго массива.  
В четвертой строке через пробел заданы m чисел b_i (1≤b_i≤100000) — второй массив.
